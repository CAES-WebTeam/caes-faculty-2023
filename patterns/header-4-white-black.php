...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-group alignfull has-base-color has-text-color caes-fac-header has-contrast-background-color has-background"><!-- wp:group {"layout":{"type":"flex","justifyContent":"space-between"}} -->
