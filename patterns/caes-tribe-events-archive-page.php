...
<!-- wp:group {"style":{"spacing":{"blockGap":"0rem"}},"className":"caes-fac-query-loop-img-exp","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","orientation":"horizontal"}} -->
<div class="wp-block-group caes-fac-query-loop-img-exp"><!-- wp:post-featured-image {"aspectRatio":"auto","width":"","className":"caes-fac-query-loop-img-container"} /-->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"caes-fac-query-loop-exp"} -->
<div class="wp-block-group caes-fac-query-loop-exp"><!-- wp:post-excerpt /-->

<!-- wp:post-terms {"term":"category","prefix":"Posted in: ","fontSize":"small"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
