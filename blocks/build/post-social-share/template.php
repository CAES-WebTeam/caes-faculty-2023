<div <?php echo get_block_wrapper_attributes(); ?>>
	...
	<li><a class="soc-twitter-icon" href="https://twitter.com/intent/tweet?text=' . ($titlepostname) . '%3A%20' . get_the_permalink($getID) . '" onclick="return !window.open(this.href, \'Share News\', \'width=500,height=500\')" target="_blank">
	<span class="visually-hidden">Share on Twitter, opens in new window</span>	
